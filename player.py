        ...
        while not valid_square:
            ...
            try:
                ...
                if val not in game.available_moves():
                    raise ValueError
                valid_square = True # if these are sucecssful, then yay
            except ValueError:
                print("Invalid square, please try again")

        return val

class SupperComputerPlayer(Player):
    def __init__(self, letter):
        super().__init__(letter)
    ...
    def minimax(self, state, player): # each time we pass in the state of the game
        ...
        if state.current_winner == other_player:
            # we should return the position and score because we nee to keep track of the score
            # for minimax to work
            return {
                "position": None,
        ...
        for possible_move in state.available_moves():
            ...
            if player == max_player: # we are atrying to mazimize the max_player
